	...
	<div class="login-box">
		<div class="card">
			<div class="card-header text-center my-0 py-2">
				<img src="<?= base_url('assets/logo-bcn.png') ?>" width="229.5px" height="50px">
				<div class="text-bold">Aplikasi Manajemen Arsip</div>
			</div>
		...
		<p class="text-center">Copyright &copy; 2022 - PT Buma Cima Nusantara</p>
	</div>
	<!-- /.login-box -->
